...
/// One native complex CSI sample with explicit validity.
...
pub struct IqSample {
    ...
    pub q: i32,
    /// Whether the source protocol marks this pair as usable.
    pub valid: bool,
}

impl IqSample {
    const fn new(i: i32, q: i32) -> Self {
        Self { i, q, valid: true }
    }

    const fn invalid(i: i32, q: i32) -> Self {
