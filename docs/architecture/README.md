...
| Trigger | Owner |
| --- | --- |
| Bounded Demo Store, per-serve capture, single atomic writer, query subset, polling, and browser seams | [Demo Slice architecture](demo-slice.md), first-applicable for the Demo |
